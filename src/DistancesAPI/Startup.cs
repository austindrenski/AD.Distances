            ...
            => services.AddLogging(x => x.AddConsole())
                       ...
                       .AddSwaggerGen(
                           x =>
                           {
                               ...
                               x.IncludeXmlComments(Path.Combine(ApplicationEnvironment.ApplicationBasePath, $"{nameof(DistancesAPI)}.xml"), true);
                               ...
                               foreach (ApiVersionDescription description in descriptions)
                               {
                                   x.SwaggerDoc(
                                       ...
                                       new Info
                                       {
                                           ...
                                           License = new License { Name = "MIT", Url = "https://github.com/austindrenski/AD.Distances/blob/master/LICENSE" },
                                           Description = "The Distances API provides distance calculation services."
                                       });
                               }
                           })
                       .AddMvc(
